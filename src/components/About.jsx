...
export default function About() {
  ...
  <div className="jumbotron jumbotron-fluid">
    <div className="container">
      ...
      <p className="mainText my-3">My name is Austin Marlatt-Foss, and I am Graduate from the University of Oregon's Fullstack Web Development Program. During this program I have learned valuable tools at becoming a Web Developer and would love the opportunity to use these skills on your project.</p>
      ...
      <p className="mainText my-3">If you have any questions about my resume or projects, feel free to send me a message in the <Link to="/Contact">Contact</Link> section.</p>
    </div>
  </div>
  );
}