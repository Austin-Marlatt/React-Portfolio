// Component that handles the portfolio page, renders my previous projects with links to both the deployed applications and their Repos.
  ...
  const projectData = [
    {
      img: "/images/NDB.png",
      name: "N.D.B.",
      description: "Multi-Page web application that utilizes NASA's API.",
      website: "https://austin-marlatt.github.io/nasa-data-base/",
      repo: "https://github.com/Austin-Marlatt/nasa-data-base"
    },
    {
      img: "/images/NoteTaker.png",
      name: "Note Taker",
      description: "A web application that allows you to create, save, and delete notes.",
      website: "https://austin-marlatt.github.io/nasa-data-base/",
      repo: "https://github.com/Austin-Marlatt/Note_Taker"
    }
  ];
